...
public static class Parser {
  ...
  public static IMessage Parse(string jsonString) {
    ...
    return (boundTo, kind) switch {
      ...
      (IMessage.BoundToKind.ClientBound, IMessage.MessageKind.AfterPlayerSwitchMainHand) =>
        JsonSerializer.Deserialize<ServerAfterPlayerSwitchMainHandMessage>(jsonString)!,
